      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-content padding">
            ...
            <?php $cek=$this->db->query("SELECT * from tbl_permohonan WHERE id_status = 5")->num_rows(); ?>
                <?php if($cek>=1) { ?>
              <thead>
                <tr>
                  <th>No</th>
              ...
              <?php 
                      $no=1;
                      foreach ($wkpn->result_array() as $row):
                    ...
                    <tr>
                        ...
                        <td>
                        <a class="btn btn-primary" href="<?php echo base_url('data/permohonan/upload_berkas/view_berkas_wkpn/'.$id_permohonan);?>" type="button" class="btn btn-xs btn-info" id="id_permohonan">Detail</a></button>
                        </td>
                      </tr>
                          <?php endforeach; ?>
              </tbody>
