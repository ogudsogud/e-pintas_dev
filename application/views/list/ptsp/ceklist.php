        ...
        <div class="widget-box">
          <div class="widget-content padding">
            ...
            <?php $cek=$this->db->query("SELECT * from tbl_permohonan WHERE id_status = 4")->num_rows(); ?>
              ...
              <?php 
                      $no=1;
                      foreach ($ptsp->result_array() as $row):
                    ...
                    <tr>
                      ...
                      <td>
                          <a class="btn btn-primary" href="<?php echo base_url('data/permohonan/upload_berkas/view_berkas_ptsp/'.$id_permohonan);?>" type="button" class="btn btn-xs btn-info" >Detail</a></button>
                        </td>
                      </tr>
                          <?php endforeach; ?>
              </tbody>
