        ...
        <div class="widget-box">
          <div class="widget-content nopadding">
            ...
            <?php $cek=$this->db->query("SELECT * from tbl_permohonan WHERE id_status = 7")->num_rows(); ?>
              ...
              <?php 
                      $no=1;
                      foreach ($panmud->result_array() as $row):
                    ...
                    <tr>
                        ...
                        <td>
                        <a class="btn btn-primary" href="<?php echo base_url('data/permohonan/upload_berkas/view_berkas_panmud/'.$id_permohonan);?>" type="button" class="btn btn-xs btn-info" id="id_permohonan">Detail</a></button>
                        </td>
                      </tr>
                          <?php endforeach; ?>
              </tbody>
